...
class Llanta:
    ...
    cuenta = 0
        ...
        #==========================
        # Función constructora de 
        #      identidad 
        # __init__ es una función
        #      reservada
...
print("Presión de la llanta 4 = ",llanta4.presión) #presión de la llanta4
...
#===================================
# Uso de la función de python 
#property para poner y obtener
#         atributos
#===================================
...
#====================================
# Ponerle nombre usando la propiedad 
# nombre y el método ponerme_nombre
# (sin tener que llamar 
#     explícitamente la función)
#====================================

estudiante.nombre = "Diego"

#====================================
# Obtener el nombre con el 
#   método obtener_nombre
# __nombre es una variable encapsulada 
#      (no visible desde fuera)
# (sin tener que llamar explícitamente
#     a la función obtener_nombre)
#=====================================
print(estudiante.nombre)

# Esto no funciona
# print(estudiante.__nobre)
...
#=====================================
# Su hijo rectángulo
# Rectangulo es hijo de Cuadrilátero
...
#======================================
# Llamar al método perímetro de su
#      abuelo Cuadrilátero
#======================================
...
#======================================
# Sobre-escribir un método de su madre 
#   o abuela o tatarabuela...
# Es volver a definir una función 
#          ya existente
#======================================
